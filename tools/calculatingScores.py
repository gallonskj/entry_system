...
def Suicidal_total_score(rPatientSuicidal_object):
    if rPatientSuicidal_object is None \
        ...
        if flag_mostdepressed == 2:
            ...
            if 100 >= total_score_mostdepressed >= 0:
                object_flag_mostdepressed = False
            else:
                object_flag_mostdepressed = True
                total_score_mostdepressed = None
...
def pleasure_total_score(rPatientPleasure_object):
    if rPatientPleasure_object.question1_answer is None \
        ...
        if 60 >= exception_total_score >= 10 and 8 <= consume_total_score <= 48:
            object_flag = False
        else:
            object_flag = True
            exception_total_score = None
...
def growth_total_score(rPatientGrowth_object):
    if rPatientGrowth_object is None \
        ...
        emotional_abuse_total_score = int(
            rPatientGrowth_object.question3_answer) + int(
            rPatientGrowth_object.question8_answer) + int(
            rPatientGrowth_object.question14_answer) + int(
            rPatientGrowth_object.question18_answer) + int(
            rPatientGrowth_object.question25_answer)

        physical_abuse_total_score = int(
            rPatientGrowth_object.question9_answer) + int(
            rPatientGrowth_object.question11_answer) + int(
            rPatientGrowth_object.question12_answer) + int(
            rPatientGrowth_object.question15_answer) + int(
            rPatientGrowth_object.question17_answer)

        sexual_abuse_total_score = int(
            rPatientGrowth_object.question20_answer) + int(
            rPatientGrowth_object.question21_answer) + int(
            rPatientGrowth_object.question23_answer) + int(
            rPatientGrowth_object.question24_answer) + int(
            rPatientGrowth_object.question27_answer)

        emotional_ignorance_total_score = (6 - int(
            rPatientGrowth_object.question5_answer)) + (6 - int(rPatientGrowth_object.question7_answer)) + (6 - int(
            rPatientGrowth_object.question13_answer)) + int(rPatientGrowth_object.question19_answer) + int(
            rPatientGrowth_object.question28_answer)

        physical_ignorance_total_score = int(
            rPatientGrowth_object.question1_answer) + (6 - int(rPatientGrowth_object.question2_answer)) + int(
            rPatientGrowth_object.question4_answer) + int(
            rPatientGrowth_object.question6_answer) + (6 - int(rPatientGrowth_object.question26_answer))

        if 5 <= emotional_abuse_total_score <= 25 and 5 <= physical_abuse_total_score <= 25 \
                and 5 <= sexual_abuse_total_score <= 25 and 5 <= emotional_ignorance_total_score <= 25 \
                and 5 <= physical_ignorance_total_score <= 25:
            object_flag = False
        else:
            object_flag = True
            emotional_abuse_total_score = None
...
def AdolescentEvents_total_score(rPatientAdolescentEvents_object):
    if rPatientAdolescentEvents_object is None \
        ...
        total_score = int(rPatientAdolescentEvents_object.question1_answer) + int(
            rPatientAdolescentEvents_object.question2_answer) + int(
            rPatientAdolescentEvents_object.question3_answer) + int(
            rPatientAdolescentEvents_object.question4_answer) + int(
            rPatientAdolescentEvents_object.question5_answer) + int(
            rPatientAdolescentEvents_object.question6_answer) + int(
            rPatientAdolescentEvents_object.question7_answer) + int(
            rPatientAdolescentEvents_object.question8_answer) + int(
            rPatientAdolescentEvents_object.question9_answer) + int(
            rPatientAdolescentEvents_object.question10_answer) + int(
            rPatientAdolescentEvents_object.question11_answer) + int(
            rPatientAdolescentEvents_object.question12_answer) + int(
            rPatientAdolescentEvents_object.question13_answer) + int(
            rPatientAdolescentEvents_object.question14_answer) + int(
            rPatientAdolescentEvents_object.question15_answer) + int(
            rPatientAdolescentEvents_object.question16_answer) + int(
            rPatientAdolescentEvents_object.question17_answer) + int(
            rPatientAdolescentEvents_object.question18_answer) + int(
            rPatientAdolescentEvents_object.question19_answer) + int(
            rPatientAdolescentEvents_object.question20_answer) + int(
            rPatientAdolescentEvents_object.question21_answer) + int(
            rPatientAdolescentEvents_object.question22_answer) + int(
            rPatientAdolescentEvents_object.question23_answer) + int(
            rPatientAdolescentEvents_object.question24_answer) + int(
            rPatientAdolescentEvents_object.question25_answer) + int(
            rPatientAdolescentEvents_object.question26_answer) + int(
            rPatientAdolescentEvents_object.question27_answer)
        if 0 <= total_score <= 135:
            object_flag = False
        else:
            object_flag = True
            total_score = None
...
def CognitiveEmotion_total_score(rPatientCognitiveEmotion_object):
    if rPatientCognitiveEmotion_object is None \
        ...
        blame_self = int(rPatientCognitiveEmotion_object.question1_answer) + int(
            rPatientCognitiveEmotion_object.question2_answer) + int(
            rPatientCognitiveEmotion_object.question3_answer) + int(
            rPatientCognitiveEmotion_object.question4_answer)

        blame_others = int(rPatientCognitiveEmotion_object.question5_answer) + int(
            rPatientCognitiveEmotion_object.question6_answer) + int(
            rPatientCognitiveEmotion_object.question7_answer) + int(
            rPatientCognitiveEmotion_object.question8_answer)

        meditation = int(rPatientCognitiveEmotion_object.question9_answer) + int(
            rPatientCognitiveEmotion_object.question10_answer) + int(
            rPatientCognitiveEmotion_object.question11_answer) + int(
        ...
        catastrophization = int(rPatientCognitiveEmotion_object.question13_answer) + int(
            rPatientCognitiveEmotion_object.question14_answer) + int(
            rPatientCognitiveEmotion_object.question15_answer) + int(
            rPatientCognitiveEmotion_object.question16_answer)

        accepted = int(rPatientCognitiveEmotion_object.question17_answer) + int(
            rPatientCognitiveEmotion_object.question18_answer) + int(
            rPatientCognitiveEmotion_object.question19_answer) + int(
        ...
        positive_refocus = int(rPatientCognitiveEmotion_object.question21_answer) + int(
            rPatientCognitiveEmotion_object.question22_answer) + int(
            rPatientCognitiveEmotion_object.question23_answer) + int(
        ...
        program_refocus = int(rPatientCognitiveEmotion_object.question25_answer) + int(
            rPatientCognitiveEmotion_object.question26_answer) + int(
            rPatientCognitiveEmotion_object.question27_answer) + int(
            rPatientCognitiveEmotion_object.question28_answer) + int(
            rPatientCognitiveEmotion_object.question27_answer) + int(
        ...
        positive_evaluation = int(rPatientCognitiveEmotion_object.question29_answer) + int(
            rPatientCognitiveEmotion_object.question30_answer) + int(
            rPatientCognitiveEmotion_object.question31_answer) + int(
        ...
        rational_analysis = int(rPatientCognitiveEmotion_object.question33_answer) + int(
            rPatientCognitiveEmotion_object.question34_answer) + int(
            rPatientCognitiveEmotion_object.question35_answer) + int(
            rPatientCognitiveEmotion_object.question36_answer)

        total_score = blame_self + blame_others + meditation + catastrophization + accepted + positive_refocus + \
                      program_refocus + positive_evaluation + rational_analysis

        if 4 <= blame_self <= 20 and 4 <= blame_others <= 20 and 4 <= meditation <= 20 \
                and 4 <= catastrophization <= 20 and 4 <= accepted <= 20 and 4 <= positive_refocus <= 20 \
                and 4 <= program_refocus <= 20 and 4 <= positive_evaluation <= 20 and 4 <= rational_analysis <= 20 \
                and 36 <= total_score <= 180:
            object_flag = False
        else:
            object_flag = True
            total_score = None
...
def SEmbu_total_score(rPatientSembu_object):
    if rPatientSembu_object is None or \
            rPatientSembu_object.question1_mother is None \
        ...
        overprotection_mother_total = int(rPatientSembu_object.question14_mother) + int(
            ...
            rPatientSembu_object.question18_mother) + int(rPatientSembu_object.question19_mother) + \
                                      (5 - int(rPatientSembu_object.question13_mother)) + int(
        ...
        overprotection_father_total = int(rPatientSembu_object.question14_father) + int(
            ...
            rPatientSembu_object.question18_father) + int(rPatientSembu_object.question19_father) + \
                                      (5 - int(rPatientSembu_object.question13_father)) + int(
            rPatientSembu_object.question21_father)

        if 6 <= refusal_mother_total <= 24 and 6 <= refusal_father_total <= 24 \
                and 7 <= emotional_warmth_mother_total <= 28 and 7 <= emotional_warmth_father_total <= 28 \
                and 8 <= overprotection_mother_total <= 32 and 8 <= overprotection_father_total <= 32:
            object_flag = False
