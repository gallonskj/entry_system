...
def HAMD17_total_score(rPatientHamd17_object):
    if rPatientHamd17_object is None \
        ...
        total_score = int(rPatientHamd17_object.depression) + int(rPatientHamd17_object.guilt) + int(rPatientHamd17_object.suicide) + int(rPatientHamd17_object.difficulty_sleeping) + \
                    int(rPatientHamd17_object.sleep_deep) + int(rPatientHamd17_object.wake_early) + int(rPatientHamd17_object.work_interest) + int(rPatientHamd17_object.slow) + \
...
def HAMA_total_score(rPatientHama_object):
    if rPatientHama_object is None \
        ...
        total_score = int(rPatientHama_object.anxiety) + int(rPatientHama_object.nervous) + int(rPatientHama_object.fear) + int(rPatientHama_object.insomnia) + int(rPatientHama_object.cognitive_function) + \
...
def Bprs_total_score(rPatientBprs_object):
    if rPatientBprs_object is None \
        ...
        total_score = int(rPatientBprs_object.health_care) + int(rPatientBprs_object.anxious) + int(rPatientBprs_object.emocommunicat_barrier) + \
                  int(rPatientBprs_object.conceptual_disorder) + int(rPatientBprs_object.guilt_concept) + int(rPatientBprs_object.nervous) + \
...
def YBO_total_score(rPatientYbobsessiontable_object):
    if rPatientYbobsessiontable_object is None \
        ...
        total_score = int(rPatientYbobsessiontable_object.forced_frequency) + int(rPatientYbobsessiontable_object.impediment_degree1) + \
...
def Suicidal_total_score(rPatientSuicidal_object):
    ...
    if rPatientSuicidal_object is None \
        ...
        flag_lastweek = int(rPatientSuicidal_object.question4_lastweek) + int(rPatientSuicidal_object.question5_lastweek)
        flag_mostdepressed = int(rPatientSuicidal_object.question4_mostdepressed) + int(rPatientSuicidal_object.question5_mostdepressed)
        if flag_lastweek == 2:
            total_score_lastweek = None
            ...
            sum_lastweek = int(rPatientSuicidal_object.question6_lastweek) + int(rPatientSuicidal_object.question7_lastweek) + int(rPatientSuicidal_object.question8_lastweek) + \
                       int(rPatientSuicidal_object.question9_lastweek) + int(rPatientSuicidal_object.question10_lastweek) + int(rPatientSuicidal_object.question11_lastweek) + \
                       int(rPatientSuicidal_object.question12_lastweek) + int(rPatientSuicidal_object.question13_lastweek) + int(rPatientSuicidal_object.question14_lastweek) + \
                       int(rPatientSuicidal_object.question15_lastweek) + int(rPatientSuicidal_object.question16_lastweek) + int(rPatientSuicidal_object.question17_lastweek) + \
...
#另一分支
        if flag_mostdepressed == 2:
            ...
            sum_mostdepressed = int(rPatientSuicidal_object.question6_mostdepressed) + int(rPatientSuicidal_object.question7_mostdepressed) + int(rPatientSuicidal_object.question8_mostdepressed) + \
                                int(rPatientSuicidal_object.question9_mostdepressed) + int(rPatientSuicidal_object.question10_mostdepressed) + int(rPatientSuicidal_object.question11_mostdepressed) + \
                                int(rPatientSuicidal_object.question12_mostdepressed) + int(rPatientSuicidal_object.question13_mostdepressed) + int(rPatientSuicidal_object.question14_mostdepressed) + \
...
def happiness_total_score(rPatientHappiness_object):
    if rPatientHappiness_object is None \
        ...
        total_score = int(rPatientHappiness_object.question1_answer) + int(rPatientHappiness_object.question2_answer) + int(rPatientHappiness_object.question3_answer) + \
                  int(rPatientHappiness_object.question4_answer) + int(rPatientHappiness_object.question5_answer) + int(rPatientHappiness_object.question6_answer) + \
...
def pleasure_total_score(rPatientPleasure_object):
    ...
    if rPatientPleasure_object.question1_answer is None \
        ...
        exception_total_score =int(rPatientPleasure_object.question1_answer) + int(rPatientPleasure_object.question4_answer) + int(rPatientPleasure_object.question6_answer) + \
                           int(rPatientPleasure_object.question8_answer) + int(rPatientPleasure_object.question10_answer) + int(rPatientPleasure_object.question11_answer) + \
                           int(rPatientPleasure_object.question13_answer) + int(rPatientPleasure_object.question15_answer) + int(rPatientPleasure_object.question16_answer) + \
...
def growth_total_score(rPatientGrowth_object):
    if rPatientGrowth_object is None\
        ...
        emotional_abuse_total_score = int(rPatientGrowth_object.question3_answer) + int(rPatientGrowth_object.question8_answer) + \
                                  int(rPatientGrowth_object.question14_answer) + int(rPatientGrowth_object.question18_answer) + \
                                  int(rPatientGrowth_object.question25_answer)
        physical_abuse_total_score = int(rPatientGrowth_object.question9_answer) + int(rPatientGrowth_object.question11_answer) + \
                                 int(rPatientGrowth_object.question12_answer) + int(rPatientGrowth_object.question15_answer) + \
                                 int(rPatientGrowth_object.question17_answer)
        sexual_abuse_total_score = int(rPatientGrowth_object.question20_answer) + int(rPatientGrowth_object.question21_answer) + \
...
def AdolescentEvents_total_score(rPatientAdolescentEvents_object):
    if rPatientAdolescentEvents_object is None \
        ...
        total_score = int(rPatientAdolescentEvents_object.question1_answer) + int(rPatientAdolescentEvents_object.question2_answer) + int(rPatientAdolescentEvents_object.question3_answer) + \
            ...
            int(rPatientAdolescentEvents_object.question10_answer) + int(rPatientAdolescentEvents_object.question11_answer) + int(rPatientAdolescentEvents_object.question12_answer) + \
            int(rPatientAdolescentEvents_object.question13_answer) + int(rPatientAdolescentEvents_object.question14_answer) + int(rPatientAdolescentEvents_object.question15_answer) + \
            int(rPatientAdolescentEvents_object.question16_answer) + int(rPatientAdolescentEvents_object.question17_answer) + int(rPatientAdolescentEvents_object.question18_answer) + \
...
def CognitiveEmotion_total_score(rPatientCognitiveEmotion_object):
    if rPatientCognitiveEmotion_object is None \
        ...
        blame_self = int(rPatientCognitiveEmotion_object.question1_answer) + int(rPatientCognitiveEmotion_object.question2_answer) + \
                     int(rPatientCognitiveEmotion_object.question3_answer) + int(rPatientCognitiveEmotion_object.question4_answer)

        blame_others = int(rPatientCognitiveEmotion_object.question5_answer) + int(rPatientCognitiveEmotion_object.question6_answer) + \
                     int(rPatientCognitiveEmotion_object.question7_answer) + int(rPatientCognitiveEmotion_object.question8_answer)

        meditation = int(rPatientCognitiveEmotion_object.question9_answer) + int(rPatientCognitiveEmotion_object.question10_answer) + \
                     int(rPatientCognitiveEmotion_object.question11_answer) + int(rPatientCognitiveEmotion_object.question12_answer)


        catastrophization = int(rPatientCognitiveEmotion_object.question13_answer) + int(rPatientCognitiveEmotion_object.question14_answer) + \
                     int(rPatientCognitiveEmotion_object.question15_answer) + int(rPatientCognitiveEmotion_object.question16_answer)


        accepted = int(rPatientCognitiveEmotion_object.question17_answer) + int(rPatientCognitiveEmotion_object.question18_answer) + \
                     int(rPatientCognitiveEmotion_object.question19_answer) + int(rPatientCognitiveEmotion_object.question20_answer)


        positive_refocus = int(rPatientCognitiveEmotion_object.question21_answer) + int(rPatientCognitiveEmotion_object.question22_answer) + \
                     int(rPatientCognitiveEmotion_object.question23_answer) + int(rPatientCognitiveEmotion_object.question24_answer)
        ...
        positive_evaluation = int(rPatientCognitiveEmotion_object.question29_answer) + int(rPatientCognitiveEmotion_object.question30_answer) + \
                     int(rPatientCognitiveEmotion_object.question31_answer) + int(rPatientCognitiveEmotion_object.question32_answer)


        rational_analysis = int(rPatientCognitiveEmotion_object.question33_answer) + int(rPatientCognitiveEmotion_object.question34_answer) + \
                     int(rPatientCognitiveEmotion_object.question35_answer) + int(rPatientCognitiveEmotion_object.question36_answer)
...
def SEmbu_total_score(rPatientSembu_object):
    if rPatientSembu_object is None \
        ...
        refusal_mother_total = int(rPatientSembu_object.question1_mother) + int(rPatientSembu_object.question2_mother) + int(rPatientSembu_object.question3_mother) + \
                     int(rPatientSembu_object.question4_mother) + int(rPatientSembu_object.question5_mother) + int(rPatientSembu_object.question6_mother)

        refusal_father_total =int(rPatientSembu_object.question1_father) + int(rPatientSembu_object.question2_father) + int(rPatientSembu_object.question3_father) + \
                     int(rPatientSembu_object.question4_father) + int(rPatientSembu_object.question5_father) + int(rPatientSembu_object.question6_father)

        emotional_warmth_mother_total = int(rPatientSembu_object.question7_mother) + int(rPatientSembu_object.question8_mother) + int(rPatientSembu_object.question9_mother) + \
                     int(rPatientSembu_object.question10_mother) + int(rPatientSembu_object.question11_mother) + int(rPatientSembu_object.question12_mother) + \
                                                                                                                      int(rPatientSembu_object.question13_mother)

        emotional_warmth_father_total =int(rPatientSembu_object.question7_father) + int(rPatientSembu_object.question8_father) + int(rPatientSembu_object.question9_father) + \
                     int(rPatientSembu_object.question10_father) + int(rPatientSembu_object.question11_father )+ int(rPatientSembu_object.question12_father) + \
...
def ATQ_total_score(rPatientAtq_object):
    if rPatientAtq_object is None \
        ...
        total_score = int(rPatientAtq_object.question1_answer) + int(rPatientAtq_object.question2_answer) + int(rPatientAtq_object.question3_answer) + \
                      int(rPatientAtq_object.question4_answer) + int(rPatientAtq_object.question5_answer) + int(rPatientAtq_object.question6_answer) + \
                      int(rPatientAtq_object.question7_answer) + int(rPatientAtq_object.question8_answer) + int(rPatientAtq_object.question9_answer) + \
                      int(rPatientAtq_object.question10_answer) + int(rPatientAtq_object.question11_answer) + int(rPatientAtq_object.question12_answer) + \
                      int(rPatientAtq_object.question13_answer) + int(rPatientAtq_object.question14_answer) + int(rPatientAtq_object.question15_answer) + \
                      int(rPatientAtq_object.question16_answer) + int(rPatientAtq_object.question17_answer) + int(rPatientAtq_object.question18_answer) + \
                      int(rPatientAtq_object.question19_answer) + int(rPatientAtq_object.question20_answer) + int(rPatientAtq_object.question21_answer) + \
