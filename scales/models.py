...
class RPatientBasicInformationHealth(models.Model):
    ...
    patient_medicine_information = models.CharField(max_length=200, blank=True, null=True)
    patient_treatment_information = models.CharField(max_length=200, blank=True, null=True)
    doctor = models.ForeignKey('users.Suser', models.DO_NOTHING)
    create_time = models.DateTimeField(auto_now_add=True)
    update_time = models.DateTimeField(auto_now=True)
    class Meta:
...
class RPatientMriExamination(models.Model):
    ...
    having_abnormal_region_field = models.IntegerField(db_column='having_abnormal_region_', blank=True, null=True)  # Field renamed because it ended with '_'.
