...
def get_redirect_url(patient_session_id, patient_id, next_type, do_scale_type):
    ...
    if min_unfinished_scale is None:
        redirect_url = '{}?patient_session_id={}&patient_id={}'.format(next_type, str(patient_session_id),
                                                                       str(patient_id))
        return redirect_url
    # /scales/get_XXX_form
